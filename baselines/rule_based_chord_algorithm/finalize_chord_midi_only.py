...
from finalize_chord import choose
...
if __name__ == '__main__':
    ...
    # input_root = '../classical_all/'
    # files = os.listdir(input_root)
    # file_path = [os.path.join(input_root, file, file+'.mid') for file in files]

    # for each in tqdm(file_path):
    #     finalize(each, save_file=True, save_summary=True)
